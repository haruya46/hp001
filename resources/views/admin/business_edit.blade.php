        ...
        <div class="mx-4 sm:p-8">
            <form enctype="multipart/form-data"method="post" action="{{route('admin.business_update',$business)}}">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <img src="{{ asset('storage/'.$business->background_image)}}" class="mx-auto" style="height:300px;">

                    <label for="image" class="font-semibold leading-none mt-4">topimage</label>
                    <input id="image" type="file" name="top_image">
                    <img src="{{ asset('storage/'.$business->top_image)}}" class="mx-auto" style="height:300px;">
                    ...
                    <img src="{{ asset('storage/'.$business->content_img_1)}}" class="mx-auto" style="height:300px;">
                    ...
                    <img src="{{ asset('storage/'.$business->content_img_2)}}" class="mx-auto" style="height:300px;">
                    ...
                    <img src="{{ asset('storage/'.$business->content_img_3)}}" class="mx-auto" style="height:300px;">
